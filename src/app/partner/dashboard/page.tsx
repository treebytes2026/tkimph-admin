  ...
  return (
    <div className="mx-auto max-w-5xl space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="border-border/80"><CardHeader className="pb-2"><CardDescription>Platform commission</CardDescription><CardTitle className="text-2xl">{formatMoney(earnings?.platform_commission ?? 0)}</CardTitle></CardHeader><CardContent className="flex items-center gap-2 text-xs text-muted-foreground"><Wallet className="size-4 text-emerald-600" />Automatic 13% share across completed sales</CardContent></Card>
      </div>
