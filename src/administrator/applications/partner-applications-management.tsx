          ...
          {detail ? (
            <div className="flex flex-1 flex-col gap-4 text-sm">
              <div className="space-y-1">
                <p className="font-semibold text-foreground">{detail.business_name}</p>
                <p className="text-muted-foreground">
                  {detail.business_type?.name} · {detail.business_category?.name ?? "—"} ·{" "}
                  {detail.cuisine?.name ?? "—"}
                </p>
              </div>
              <div className="grid gap-1 rounded-lg border border-border/60 bg-muted/30 p-3">
                <p>
                  <span className="text-muted-foreground">Owner:</span> {detail.owner_first_name}{" "}
                  {detail.owner_last_name}
                </p>
                <p>
