...
export function CheckoutAuthPanel({ onSignedIn }: CheckoutAuthPanelProps) {
  ...
  function handleRegister(e: React.FormEvent) {
    ...
    setInfo(
      "Account creation is not enabled yet. Please sign in with an existing account or contact support."
    );
  }
  ...
  return (
    <div className="rounded-2xl border border-border/80 bg-card p-6 shadow-sm sm:p-8">
      <h1 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl">Almost there</h1>
      <p className="mt-1 text-sm text-muted-foreground sm:text-base">
        Sign up or log in to continue checkout.
      </p>
      ...
      <div className="flex gap-2 rounded-full bg-primary/10 p-1">
        <button
          type="button"
          onClick={() => {
            setTab("login");
      ...
      {tab === "login" ? (
        <form onSubmit={handleLogin} className="mt-6 space-y-4">
          ...
          <Button type="submit" className="mt-2 h-11 w-full rounded-xl font-semibold" disabled={loading}>
            {loading ? (
        ...
        <form onSubmit={handleRegister} className="mt-6 space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="checkout-reg-email">Email</Label>
            <Input
          ...
          <div className="space-y-2">
            <Label htmlFor="checkout-reg-password">Password</Label>
            <Input
          ...
          <div className="space-y-2">
            <Label htmlFor="checkout-reg-confirm">Confirm password</Label>
            <Input
              id="checkout-reg-confirm"
              type={showPassword ? "text" : "password"}
              placeholder="••••••••"
          ...
          <Button type="submit" className="mt-2 h-11 w-full rounded-xl font-semibold">
